...
import 'package:nfc_in_flutter_example/registration_page.dart';
import 'package:nfc_in_flutter_example/splash_screen.dart';
          ...
          actions: [
            PopupMenuButton(
              ...
              return [
                PopupMenuItem<int>(
                  value: 0,
                  child: Text("Visiter le site web"),
                ),
              ];
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ReadExampleScreen()),
                          );
                        },
                        child: Text('Read NFC'),
                      ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => WriteExampleScreen()),
                          );
                        },
